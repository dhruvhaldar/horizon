...
# Security: Add security middleware FIRST so it becomes the innermost middleware,
# wrapped by CORSMiddleware. This ensures CORS headers are applied even to 500
# errors generated by the security middleware itself, preventing CORS bypasses.
